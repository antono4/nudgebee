...
func (sc *SecurityContext) ListK8sObjectNames(accountId string, resourceType string, permission K8sRbacPermissionType) ([]string, error) {
	if resourceType == K8sObjectNamespaces && (slices.Contains(sc.roles, AUTH_K8S_NAMESPACE_ADMIN_ROLE) || (slices.Contains(sc.roles, AUTH_K8S_NAMESPACE_READ_ADMIN_ROLE) && (permission == K8sRbacPermissionTypeGet || permission == K8sRbacPermissionTypeList))) {
